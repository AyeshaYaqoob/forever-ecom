...
const SubHero = () => {
  ...
  // Build countUp hooks for each stat (max 4 stats supported)
  const stat1 = useCountUp(subHeroConfig.stats[0]?.value || 0, 2000, statsVisible);
  const stat2 = useCountUp(subHeroConfig.stats[1]?.value || 0, 2000, statsVisible);
  const stat3 = useCountUp(subHeroConfig.stats[2]?.value || 0, 2000, statsVisible);
  const stat4 = useCountUp(subHeroConfig.stats[3]?.value || 0, 2000, statsVisible);
